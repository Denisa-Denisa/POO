...
public class Rio {
	...
	public Rio(int id, String nombre, double longitud, String lugarNacimiento, String desembocadura) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public Rio clone() {
		Rio r = new Rio(getId(), getNombre(), getLongitud(), getLugarNacimiento(), getDesembocadura());

		for (Afluente af : afluentes) {
			r.insertarAfluente(af.clone());
		}

		return r;
	}

	public boolean equals(int idRio) {
		return id == idRio;
	}
	...
	public String toString() {
		...
		return "Rio: " + id + " " + nombre + " " + longitud + " " + lugarNacimiento + " " + desembocadura
				+ "\nCiudades por las que pasa: \n" + misCiudades + "\n" + "Afluentes:\n" + misAfluentes + "\n";
	}

	public void escribirAfluentes() {
		for (Afluente a : afluentes) {
			System.out.printf("%s%d %s%n", "", a.getId(), a.getNombre());
			a.escribirAfluentes("\t" + "");
		}
	}
}
